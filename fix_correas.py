...
for correa_incorrecta in tqdm(correas_incorrectas):
    ...
    for correa_correcta in correas_correctas:
        ...
        if(correa_incorrecta[0]==correa_correcta[1]):
            ...
            correa_incorrecta_inv_matriz.append(sucursal.inventrio_matriz(correa_incorrecta[1]))
            ...
            correa_correcta_inv_matriz.append(sucursal.inventrio_matriz(correa_correcta[2]))
            ...
            if(codigo in correa_correcta[0]):
                ...
                correa_incorrecta_inv_matriz.append(sucursal.inventrio_matriz(correa_incorrecta[0]))
                ...
                if(len(correa_correcta)==2):
                    ...
                    correa_correcta_inv_matriz.append(sucursal.inventrio_matriz(correa_correcta[1]))
