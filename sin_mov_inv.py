...
sin_movimiento.to_csv(r'./results/productos sin movimiento o inventario.csv', header={"Codigo","Descripcion","Grupo","Fecha Compra","Fecha Venta","Inv Bodega","Inv Matriz","Inv Serena","Inv Industrial"}, index=True, sep=',', mode='w')
