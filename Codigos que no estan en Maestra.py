...
for i in tqdm(range(len(condigos_la_serena))):
    if(condigos_la_serena[i] not  in condigos_maestra):
...
for i in tqdm(range(len(condigos_barrio_industrial))):
    if(condigos_barrio_industrial[i] not in condigos_maestra):
...
for i in tqdm(range(len(condigos_bodega))):
    if(condigos_bodega[i] not in condigos_maestra):
...
for i in tqdm(range(len(condigos_matriz))):
    if(condigos_matriz[i] not in condigos_maestra):
