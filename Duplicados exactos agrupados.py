...
if(base_datos == 1): #Busca los duplicados en la maestra
    ...
    FILE_NAME = "BODEGA CENTRAL Duplicados exactos agrupados.xlsx"
...
try:
  ...
  #  resultado.to_excel('industrial.xlsx',index=False)
    resultado.to_excel(funciones.RESULTS_PATH+FILE_NAME, index=False, columns=["Descripcion","Duplicados","Stock Bodega","Inventario Bodega","Stock Matriz","Inventario Matriz","Stock La Serena","Inventario La Serena","Stock Industrial","Inventario Industrial","Ult. compra","Ult. venta"])
    ...
    # resultado.to_csv(r''+funciones.RESULTS_PATH+FILE_NAME, header={"Descripcion","Grupo","Subgrupo","Codigos donde esta duplicado"}, index=False, sep=',', mode='w')
